...
set, map, ab, concept of word vs WORD, ctags, tag stacking or tag stacks, power user, transparent editing,
...
Regex support
  ...
  look into isident, iskeyword, isfname, and isprint options
