...
read errors), special buffers (quickfix, help, directory, scratch), alternate file (saved in the hashtag register) or alternate buffer, VIMRUNTIME dir,
...
Writing text
  ...
  completion
    ...
    dictionary option keywords
      initially dictionary option is empty; must add a dictionary file
    thesaurus option keywords
      initially thesaurus option is empty; must add a thesaurus file
